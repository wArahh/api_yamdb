...
csv_names_model_function = (
    ...
    ('titles', Title, _db_functions.bulk_create_titles),
    ('genre_title', None, _db_functions.create_title_genre),
    ('review', Review, _db_functions.bulk_create_reviews_comments),
    ('comments', Comments, _db_functions.bulk_create_reviews_comments)
)
...
def run_populating():
    for csv_name, model, func in csv_names_model_function:
        ...
        with open(url_to_csv_file, 'r') as csv_file:
            csv_reader = csv.DictReader(csv_file)
            if not func:
                _db_functions.universal_bulk_create(
